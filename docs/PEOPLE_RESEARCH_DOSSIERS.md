# People research dossiers (summary)

**Date:** 2026-08-02  
**Coverage matrix:** `docs/PEOPLE_BIOGRAPHY_COVERAGE.csv`  
**Backup:** `backup-before-all-family-biographies-2026-08-02`

## Layer 1 — Category A (central deceased)
...
| Nina V. | Expanded profile | chart 005; museum; ch. 17–18 | — |

## Category C — wartime correspondents

| Person | Status |
|--------|--------|
| Dmitry (103–104) | evidence_limited — no surname |
| Misha Friolenko | evidence_limited — letter only |
| Gennady Vokhmintsev | evidence_limited — letters 131–133 |

## Category E — living

Sons/grandchildren: years + kinship on chart only; no person pages; no portraits.

## Category D

F. E. Dzerzhinsky: historical context in captions only.

## Method notes

- Manuscript = family memory primary; legal/employment facts cross-checked when documents exist.
- No Google AI as source.
- No invention of death dates, medical detail, or full living biographies.
- RU/EN expanded in lockstep for A-layer pages touched this pass.
