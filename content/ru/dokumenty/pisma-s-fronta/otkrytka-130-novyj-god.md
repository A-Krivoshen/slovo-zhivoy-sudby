---
title: "Новогодняя открытка (лист 130)"
date: 2026-08-01
weight: 25
draft: false
...
{{< figure src="/photos/dnevnik-tt/str-130.jpg" caption="Новогодняя открытка. Семейный архив." >}}

## Реквизиты

| | |
|---|---|
| **Что это** | Почтовая / поздравительная открытка (многоязычный бланк) |
| **Кому** | «Таничка» |
| **От кого / год** | **требует сверки** по подписи и штемпелям |
| **Связь** | Коллекция [писем военных лет](/dokumenty/pisma-s-fronta/); контекст в [письмах товарищей](/vospominaniya/dnevnik/15-pisma-voennye-128-133/) |
...
Далее — стихотворное поздравление; часть строк читается неуверенно **[?]**.  
Адресный блок и подпись — **требуют сверки** по оригиналу.
...
Таничка! Поздравляю
С НОВЫМ ГОДОМ
[стихотворный текст — по скану; неразборчивое — [?]]
```
