...
description: "Расшифровка рукописной тетради Татьяны Тимофеевны «Наша родословная: Самсоновы» — по главам, от первого лица; партии сканов публикуются блоками."
summary: "Партии сканов — главы расшифровки; архив пополняется (в т. ч. 080–099)"
...
Опубликована **первичная расшифровка** рукописи (сначала ~79 стр., затем продолжение новой партии сканов). Текст постепенно сверяется с оригиналом; спорные места обозначены явно (`[?]`, `[неразборчиво]`). Это **не** означает, что все страницы уже вычитаны вручную от корки до корки.
